 ...
 * 
 * @author 戴小刚<br/>
 *         实现的主要功能:apk 更新 创建日期：2014-11-14 修改者，修改日期，修改内容。
 */
public class UpdateDownLoaderUtils {
	public static final String KEY_NAME_DOWNLOAD_ID = "downloadId";
	public static String download_filename = "ichsy";
	public static String download_floder_name = "com.ichsy.android.mboss";
	private static DownloadChangeObserver downloadObserver; // 下载进度的观察者
	private DownloadManager downloadManager; // 下载的管理器
	private static DownloadManagerPro downloadManagerPro;
	private static long downloadId = 0; // downLoad 的 id
	private Context context;
	private String description;
	private String descriptionTitle;
	private boolean onlyOneTask; // 是否是单任务的
	...
	private void downLoaderStartAndSetNotifycation(String apk_urls) {
		...
		request.setDestinationInExternalPublicDir(download_floder_name,
				download_filename);
	...
	public static class CompleteReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (completeDownloadId == downloadId) {
				if (downloadManagerPro.getStatusById(downloadId) == DownloadManager.STATUS_SUCCESSFUL) { // 8
	...
	public void setDownload_filename(String download_filename) {
		if (TextUtils.isEmpty(download_filename)) {
			...
			UpdateDownLoaderUtils.download_filename = download_filename
					+ ".apk";
		}
	}
	...
	private void updateView() {
		...
		UpdateDownLoaderUtils.downloaderCallbackListener.downloadSizeChange(
