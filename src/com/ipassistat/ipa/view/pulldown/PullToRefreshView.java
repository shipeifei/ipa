...
/**
 * 支持listview，gridview，Scrollerview的下拉刷新控件
 * 
 * Package: com.ichsy.hml.view.pulldown  
 *  
 * File: PullToRefreshView.java   
 *  
 * @author: 任恒   Date: 2015-1-28  
 *
...
//	private String mLastUpdateTime;
	 ...
	 * 是否上拉加载更多
	 */
	private boolean isFootRefresh = true;
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.listview_header, this, false);
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.z_arrow_down);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		...
		mFooterImageView.setImageResource(R.drawable.z_arrow_down);
		mFooterTextView.setText(R.string.pull_to_refresh_pull_label);
...
//	}
	...
	public boolean isFootRefresh() {
		return isFootRefresh;
	}

	public void setFootRefresh(boolean isFootRefresh) {
		this.isFootRefresh = isFootRefresh;
	}
