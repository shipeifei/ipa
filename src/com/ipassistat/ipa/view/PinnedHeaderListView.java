...
/** 仿联系人，ＱＱ联系人列表的粘性　ListView 的实现，适配器 TrialCenterAdapter ，试用时ListView先添加数据，再设置监听
 * 监听是 adapter ,因为该Adapter 实现了 onScrollListener
 * @author maoyn
 *
 */
/**
...
public class PinnedHeaderListView extends ListView {
	...
	public void configureHeaderView(int position) {
		...
		int state = PinnedHeaderAdapter.PINNED_HEADER_GONE; // 消除下拉刷新时的显示
		...
		case PinnedHeaderAdapter.PINNED_HEADER_PUSHED_UP: {
			...
			int headerHeight = mHeaderView.getHeight(); // �õ�ͷ��ͼ�ĸ߶�
			int y;
			int alpha;
